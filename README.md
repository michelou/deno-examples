...
- [Deno 1.24][deno_downloads] <sup id="anchor_01">[1](#footnote_01)</sup> ([*release notes*][deno_relnotes])
...
Tool versions:
   deno 1.24.3, deployctl 0.4.0, ncat 7.92, rustc 1.62.0,
   git 2.37.2.windows.1, diff 3.8
Tool paths:
   C:\opt\deno-1.24.3\deno.exe
...
deno 1.24.3 (release, x86_64-pc-windows-msvc)
...
[deno_relnotes]: https://github.com/denoland/deno/releases/tag/v1.24.3
