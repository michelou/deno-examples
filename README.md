...
Tool versions:
   deno 1.29.2, deployctl 0.4.0, ncat 7.93, rustc 1.65.0,
   git 2.39.0.windows.1, diff 3.8
Tool paths:
   C:\opt\deno-1.29.2\deno.exe
...
[deno_relnotes]: https://github.com/denoland/deno/releases/tag/v1.29.2
