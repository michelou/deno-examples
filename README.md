...
Tool versions:
   deno 1.26.2, deployctl 0.4.0, ncat 7.93, rustc 1.62.0,
   git 2.38.1.windows.1, diff 3.8
Tool paths:
   C:\opt\deno-1.26.2\deno.exe
...
<a href="https://v8.dev/">v8</a> 10.7.193.16
...
[deno_relnotes]: https://github.com/denoland/deno/releases/tag/v1.26.2
