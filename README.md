...
Tool versions:
   deno 1.33.1, deployctl 1.5.0, node v18.16.0, ncat 7.93, rustc 1.68.1,
   git 2.40.1.windows.1, diff 3.9
Tool paths:
   C:\opt\deno-1.33.1\deno.exe
...
<!-- deno 1.33.1: v8 11.2.214.9 , typescript 5.0.3 -->
...
[deno_relnotes]: https://github.com/denoland/deno/releases/tag/v1.33.1
