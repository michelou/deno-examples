...
Tool versions:
   deno 1.29.3, deployctl 0.4.0, ncat 7.93, rustc 1.65.0,
   git 2.39.0.windows.1, diff 3.8
Tool paths:
   C:\opt\deno-1.29.3\deno.exe
...
<!-- deno 1.29.3: v8 10.9.194.5,  typescript 4.8.3 -->
...
[deno_relnotes]: https://github.com/denoland/deno/releases/tag/v1.29.3
