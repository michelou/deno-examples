...
Tool versions:
   deno 1.25.0, deployctl 0.4.0, ncat 7.92, rustc 1.62.0,
   git 2.37.2.windows.1, diff 3.8
Tool paths:
   C:\opt\deno-1.25.0\deno.exe
...
<!-- deno 1.25.0: v8 10.6.194.5 , typescript 4.7.4 -->
...
[deno_relnotes]: https://github.com/denoland/deno/releases/tag/v1.25.0
