...
set _LAST_MODIFIED_OLD=michelou/)/February 2025
set _LAST_MODIFIED_NEW=michelou/)/May 2025

set _LAST_DOWNLOAD_OLD=(\*February 2025\*)
set _LAST_DOWNLOAD_NEW=(*May 2025*)
