...
set _LAST_MODIFIED_OLD=michelou/)/July 2025
set _LAST_MODIFIED_NEW=michelou/)/August 2025

set _LAST_DOWNLOAD_OLD=(\*July 2025\*)
set _LAST_DOWNLOAD_NEW=(*August 2025*)
